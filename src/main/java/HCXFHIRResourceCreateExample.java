...
public class HCXFHIRResourceCreateExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
            parsing different resources from bundle string
         */
//        System.out.println("Checking operation " + resourceTypeToClass.valueOf(resourceTypeToClass.getEnumByString("/coverageeligibility/check")).getFhirClass());
//
//
//        String bundleString = p.encodeResourceToString(bundleTest);
//        System.out.println("bundle String " + bundleString);
//        Bundle newBundle = (Bundle) p.parseResource(resourceTypeToClass.valueOf(resourceTypeToClass.getEnumByString("/coverageeligibility/check")).getFhirClass(), bundleString);
...
//            if(dm.getClass() == CoverageEligibilityRequest.class){
//                System.out.println("index " + i);
//                newBundle.getEntry().remove(dm);
//
//            }
//            if(dm.getClass() == CoverageEligibilityResponse.class){
//                System.out.println("index " + i);
//                ((CoverageEligibilityResponse) dm).getError().add(new CoverageEligibilityResponse.ErrorsComponent(new CodeableConcept(new Coding().setSystem("htttp://ig.protocol/adjudication-error").setCode("100").setDisplay("Coverage Eligibility Request has been rejected"))));
//            }
//
//        }
//        System.out.println("new bundle made " + newBundle);
        /**
...
//        System.out.println("Coverage Eligibility Response Example \n" +  p.encodeResourceToString(bundleCovRes) + "\n");
        ...
        System.out.println("generated payload claim " + outmap);
